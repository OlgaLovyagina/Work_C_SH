...
void Task31()
{
    ...
    FillArreyy(numbers, -9, 9); //  вызов метода на заполнения массива, (numbers) таким образом мы сюда передаем массив
    PrintArreyy(numbers); //  вызов метода на вывод массива
    Console.WriteLine(GetSummPositive(numbers));
    Console.WriteLine(GetSummNegative(numbers));
}

    int GetSummPositive(int[] numbers) //находит сумму положительных элементов массива
    {
        int sum = 0;
    ...
    int GetSummNegative(int[] numbers) //находит сумму отрицательных элементов массива
{
    int sum = 0;
    for (int i = 0; i < numbers.Length; i++)
    {
    ...
    void FillArreyy(int[] numbers, int minValue = 0, int maxValue = 100) 
...

{
    ...
    void PrintArreyy(int[] numbers) //  метод на вывод массива
    {
...
void Task32()
{
    int size = 12;
    int[] numbers = new int[size]; // int[] numbers это переменная,new int[size] это сам массив
    FillArrey1(numbers, -9, 9); //  вызов метода на заполнения массива, (numbers) таким образом мы сюда передаем массив
    PrintArrey1(numbers); //  вызов метода на вывод массива
}

void FillArrey(int[] numbers, int minValue = 0, int maxValue = 100)
//  метод на заполнения массива
//int minValue = 0, int maxValue = 100 это значения по умолчанию
...
void PrintArrey1(int[] numbers) //  метод на вывод массива
{
    for (int i = 0; i < numbers.Length; i++)// цикл на вывод массива   
    {
        numbers[i] *= -1;
